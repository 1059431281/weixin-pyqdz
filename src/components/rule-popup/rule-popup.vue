          ...
          <view class="list">
            ...
            <view class="list_box">
              ...
              <view class="list_right">
                ...
                <image
                  class="list_img"
                  src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/rule1.png"
                  mode="widthFix"
                />
              </view>
            </view>
            <view class="list_box">
              ...
              <view class="list_right">
                ...
                <image
                  class="list_img"
                  src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/rule2.png"
                  mode="widthFix"
                />
              </view>
            </view>
            <view class="list_box">
              ...
              <view class="list_right"
                ...
                <image
                  class="list_img"
                  src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/rule3.png"
                  mode="widthFix"
                />
              </view>
            </view>
        ...
        <view class="rule_content">
          ...
          <view class="list">
            ...
            <view class="list_box">
              ...
              <view class="list_right">
                ...
                <image
                  class="list_img"
                  src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/auto1.png"
                  mode="widthFix"
                />
              </view>
            </view>
            <view class="list_box">
              ...
              <view class="list_right"
                ...
                <image
                  class="list_img"
                  src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/auto2.png"
                  mode="widthFix"
                />
              </view>
            </view>
          ...
          <view class="list">
            ...
            <image
              ...
              src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/auto3.png"
              mode="widthFix"
            />
          </view>
        </view>
        ...
        <view class="rule_content">
          <view class="list">
            ...
            <image
              ...
              src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/art1.png"
              mode="widthFix"
            />
            <view class="list_box">然后再长按图片保存到手机即可。</view>
            <image
              class="list_img artimg"
              src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/art2.png"
              mode="widthFix"
            />
          </view>
          <view class="list">
            ...
            <image
              class="list_img artimg"
              src="https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/art4.png"
              mode="widthFix"
            />
          </view>
        </view>
