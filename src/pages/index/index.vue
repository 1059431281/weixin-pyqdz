      ...
      >
        ...
        >
          <label class="label">
            ...
            <image
              class="list_img"
              :src="`https://cdn.jsdelivr.net/gh/1059431281/Blog-source/img/weixin-dz/type${
                index + 1
              }.jpeg`"
              mode="widthFix"
            ></image>
...
export default {
  ...
  methods: {
    ...
    goGit() {
      window.open("https://github.com/1059431281/weixin-pyqdz");
    },
